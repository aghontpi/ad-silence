...
val spotifyTrigger = arrayOf(
    ...
    "A dal a rövid üzenet után indul",
    "Lagu kamu akan diputar setelah pesan singkat ini",
    "Lagið spilast eftir þessi stuttu skilaboð",
    "Il brano inizierà dopo questo breve messaggio",
    "הישר יושמע אחרי ההודעה הקצרה הבאה",
    "音楽は広告の後に再生されます",
    "ಈ ಕಿರು ಸಂದೇಶದ ನಂತರ ನಿಮ್ಮ ಹಾಡು ಪ್ಲೇ ಆಗುತ್ತದೆ",
    "짧은 광고 후에 곡이 재생됩니다.",
    ...
    "آهنگ شما بعد از این پیام کوتاه پخش خواهد شد",
    "Låten din spilles av etter denne korte meldingen",
    "तपाईंको गीत यो छोटो सन्देश सकिएपछि बज्ने छ",
    "Het nummer begint na deze korte reclameboodschap.",
    "ଆପଣଙ୍କର ଗୀତ ଏହି କ୍ଷୁଦ୍ର ବାର୍ତ୍ତା ପରେ ଚାଲିବ",
    "ਤੁਹਾਡਾ ਗਾਣਾ ਇਸ ਛੋਟੇ ਸੁਨੇਹੇ ਤੋਂ ਬਾਅਦ ਚੱਲੇਗਾ",
    "تہاڈا گانا ایس چھوٹے پیغام توں بعد چلایا جاوے گا",
    "Utwór zostanie odtworzony po krótkim komunikacie.",
    "Sua música será reproduzida depois desta breve mensagem",
    "A tua música será reproduzida após esta breve mensagem",
    "Melodia ta se va reda după acest mesaj scurt",
    "Трек начнется после короткого сообщения",
    "Skladba sa prehrá po tejto krátkej správe",
    "Tvoja skladba se bo predvajala po tem kratkem sporočilu",
    "Pesma će se pustiti posle ove kratke poruke",
    "Låten spelas upp efter det här korta meddelandet",
    "Wimbo wako utachezwa baada ya ujumbe huu mfupi",
